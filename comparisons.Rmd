...
for (k in (h+3):(m+2)) {
  ...
  ## Le contexte des ocurrences paires
...
## Le contexte des ocurrences impaires
...
## Effets conjoints de parité et de myopie

## Les pourcentages indiqués en première ligne (resp. en deuxième ligne) des tableaux sont ceux pour lesquels l'heuristique de classe paire (resp. impaire) l'emporte sur l'heuristique de classe impaire (resp. paire). Les tableaux concernés sont les suivants: perct, perct_21, perct_43, perct_41, perct_32.

## En particulier, le tableau perct compare la meilleure des heristiques de classes paires 4 et 2 et la meilleure des heuristiques de classes impaires 1 et 3.
...
## Les pourcentages indiqués dans toutes les lignes des tableaux sont ceux pour lesquels l'heuristique de classe supérieure l'emporte sur l'heuristique de classe inférieure. Les tableaux concernés sont les suivants: perct_31, perct_42 et perctm.

## En particulier, le tableau perctm compare la meilleure des heristiques de classes supérieures 4 et 3 et la meilleure des heuristiques de classes inférieures 1 et 2.
...
return(list(perct, perct_21, perct_43, perct_41, perct_32, perct_31, perct_42, perctm, p_value, p_value_21, p_value_43, p_value_41, p_value_32, p_value_31, p_value_42, p_value_m))
}
```
